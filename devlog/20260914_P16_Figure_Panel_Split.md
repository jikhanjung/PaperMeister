...
> **9/16 개정분**: fsis가 9/16에 두 문서를 다시 고쳤다(21건 PDF 직접 검수, 0.6.99). 새로 온 것과 그에 따른 **PaperMeister 쪽 준비 목록**
> (명세 v2 · 프롬프트 소재 · `link_payload` · 검증·반영 · `panel_key` 재검토 · 스키마 보강 · 보호 판정 · 검수 도구)은
> [P17](./20260916_P17_P16_Client_Readiness_For_ocrserver.md). §6 명세는 P17 §3.1로 개정 예정.
