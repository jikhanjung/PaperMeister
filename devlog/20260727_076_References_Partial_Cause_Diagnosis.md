...
정확히 B가 된다. 075에서 본 크래시 루프와 동일 사건의 다른 얼굴일 수 있다. 사용자가
서버에 넣은 crash 대비 조치(자동 재시작류)가 502를 줄이는 대신 **부분 응답 200**으로
바꿔놨다면, PARTIAL 급증(18% → 80%)과 502 소멸이 동시에 일어난 것도 설명된다.
