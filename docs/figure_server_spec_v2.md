...
- **답이 큰 논문은 항목 여럿으로 나뉜다**(2026-09-17 Balašova 1976 도판 91, 09-18 Barrande 1852a 플레이트 18장도 실패). ocrserver 실측: 끊김은 **출력 크기**를 따른다(5k 토큰 미만 0건, 15k 초과 5/18).
  클라이언트가 due 도판을 쪽 순서로 **예상 답 무게**(플레이트 8 · 본문 그림 1)가 80 이하가 되게 묶어 같은 잡의 항목으로 보낸다 — 키 `…@<version>#i/n`, `part: [i, n]`,
  잠긴 context 행은 모든 항목에. 항목마다 세션이 따로 돌므로 답이 작아진다. 서버 변경 없음. (1191: 6항목 · 3853: 2항목 · 664: 1항목)
