...
- **코드 품질 인프라 도입 (P15, ../Modan2 가이드 기반)** — [R01 검토](./devlog/20260723_R01_Code_Quality_Guide_Adoption.md) · [P15 계획](./devlog/20260723_P15_Code_Quality_Adoption_Plan.md)
  ...
  - **✅ P15 전 6단계 완료**. **미실행(의도적)**: `ruff format` 대량-diff 커밋, vulture(데드코드, 사용자 제외), 엄격 coverage gate/Dependabot/코드사이닝(1인 도구 과잉). 릴리스 후속: Inno Setup 설치본/아이콘/mac·Linux 레그/CHANGELOG 소싱 릴리스노트
